...
export const PatchNotesIdFormFields = () => {
  return (
    <>
...
export type PatchNotesIdFormProps = {
  id: number
  defaultValues: PatchNotesIdFormBody
  onSuccess: () => void
}

export type PatchNotesIdFormPathParams = { id: number }

export const PatchNotesIdForm = (props: PatchNotesIdFormProps) => {
  const form = useForm<PatchNotesIdFormBody>({
