...
export type UpdateDeviceExposuresDeviceExposureIdFormBody = {
  person_id: number
...
export type UpdateDeviceExposuresDeviceExposureIdFormProps = {
  ...
  defaultValues: UpdateDeviceExposuresDeviceExposureIdFormBody
  onSuccess: () => void
}

export type UpdateDeviceExposuresDeviceExposureIdFormPathParams = {
  device_exposure_id: number
}

export const UpdateDeviceExposuresDeviceExposureIdForm = (
  props: UpdateDeviceExposuresDeviceExposureIdFormProps,
) => {
  const form = useForm<UpdateDeviceExposuresDeviceExposureIdFormBody>({
  ...
  const mutator = useUpdateApiDeviceExposuresDeviceExposureId()
