...
export type UpdateVisitOccurrencesVisitOccurrenceIdFormBody = {
  person_id: number
...
export type UpdateVisitOccurrencesVisitOccurrenceIdFormProps = {
  ...
  defaultValues: UpdateVisitOccurrencesVisitOccurrenceIdFormBody
  onSuccess: () => void
}

export type UpdateVisitOccurrencesVisitOccurrenceIdFormPathParams = {
  visit_occurrence_id: number
}

export const UpdateVisitOccurrencesVisitOccurrenceIdForm = (
  props: UpdateVisitOccurrencesVisitOccurrenceIdFormProps,
) => {
  const form = useForm<UpdateVisitOccurrencesVisitOccurrenceIdFormBody>({
  ...
  const mutator = useUpdateApiVisitOccurrencesVisitOccurrenceId()
