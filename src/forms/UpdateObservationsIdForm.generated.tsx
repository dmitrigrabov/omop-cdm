...
export const UpdateObservationsIdFormFields = () => {
  return (
    <>
...
export type UpdateObservationsIdFormProps = {
  id: number
  defaultValues: UpdateObservationsIdFormBody
  onSuccess: () => void
}

export type UpdateObservationsIdFormPathParams = { id: number }

export const UpdateObservationsIdForm = (
  props: UpdateObservationsIdFormProps,
) => {
  const form = useForm<UpdateObservationsIdFormBody>({
  ...
  return (
    <Form {...form}>
      ...
      >
        <UpdateObservationsIdFormFields />
