...
import { usePatchApiVisitOccurrencesId } from '@/services/usePatchApiVisitOccurrencesId.generated.ts'
...
export type PatchVisitOccurrencesIdFormBody = {
...
export const PatchVisitOccurrencesIdFormFields = () => {
  return (
    <>
...
export type PatchVisitOccurrencesIdFormProps = {
  id: number
  defaultValues: PatchVisitOccurrencesIdFormBody
  onSuccess: () => void
}

export type PatchVisitOccurrencesIdFormPathParams = { id: number }

export const PatchVisitOccurrencesIdForm = (
  props: PatchVisitOccurrencesIdFormProps,
) => {
  const form = useForm<PatchVisitOccurrencesIdFormBody>({
  ...
  const mutator = usePatchApiVisitOccurrencesId()
  ...
  return (
    <Form {...form}>
      ...
      >
        <PatchVisitOccurrencesIdFormFields />
