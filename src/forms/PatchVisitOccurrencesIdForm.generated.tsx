...
export type PatchVisitOccurrencesIdFormProps = {
  id: string
  defaultValues: Required<PatchVisitOccurrencesIdFormBody>
  onSuccess: () => void
}

export type PatchVisitOccurrencesIdFormPathParams = { id: string }

export const PatchVisitOccurrencesIdForm = (
  props: PatchVisitOccurrencesIdFormProps,
) => {
  const form = useForm<Required<PatchVisitOccurrencesIdFormBody>>({
    resolver: zodResolver(clinicalVisitOccurrenceUpdate.required()),
