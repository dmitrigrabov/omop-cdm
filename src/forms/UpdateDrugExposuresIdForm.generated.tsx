...
export type UpdateDrugExposuresIdFormProps = {
  id: string
  defaultValues: Required<UpdateDrugExposuresIdFormBody>
  onSuccess: () => void
}

export type UpdateDrugExposuresIdFormPathParams = { id: string }

export const UpdateDrugExposuresIdForm = (
  props: UpdateDrugExposuresIdFormProps,
) => {
  const form = useForm<Required<UpdateDrugExposuresIdFormBody>>({
