...
import { useUpdateApiDrugExposuresId } from '@/services/useUpdateApiDrugExposuresId.generated.ts'
...
export type UpdateDrugExposuresIdFormBody = {
  person_id: number
...
export const UpdateDrugExposuresIdFormFields = () => {
  return (
    <>
...
export type UpdateDrugExposuresIdFormProps = {
  id: number
  defaultValues: UpdateDrugExposuresIdFormBody
  onSuccess: () => void
}

export type UpdateDrugExposuresIdFormPathParams = { id: number }

export const UpdateDrugExposuresIdForm = (
  props: UpdateDrugExposuresIdFormProps,
) => {
  const form = useForm<UpdateDrugExposuresIdFormBody>({
  ...
  const mutator = useUpdateApiDrugExposuresId()
  ...
  return (
    <Form {...form}>
      ...
      >
        <UpdateDrugExposuresIdFormFields />
