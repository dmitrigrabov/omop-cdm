...
export const CreateDrugExposuresFormFields = () => {
  return (
    <>
...
export type CreateDrugExposuresFormProps = {
  defaultValues: CreateDrugExposuresFormBody
  onSuccess: () => void
}
...
export const CreateDrugExposuresForm = (
  ...
  const form = useForm<CreateDrugExposuresFormBody>({
