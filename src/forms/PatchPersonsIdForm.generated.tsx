...
import { usePatchApiPersonsId } from '@/services/usePatchApiPersonsId.generated.ts'
...
export type PatchPersonsIdFormBody = {
...
export type PatchPersonsIdFormProps = {
  id: string
  defaultValues: Required<PatchPersonsIdFormBody>
  onSuccess: () => void
}

export type PatchPersonsIdFormPathParams = { id: string }

export const PatchPersonsIdForm = (props: PatchPersonsIdFormProps) => {
  const form = useForm<Required<PatchPersonsIdFormBody>>({
    resolver: zodResolver(clinicalPersonUpdate.required()),
    defaultValues: props.defaultValues,
  })

  const lens = useLens(form)

  const mutator = usePatchApiPersonsId()
