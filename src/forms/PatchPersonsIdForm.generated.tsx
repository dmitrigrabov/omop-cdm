...
export const PatchPersonsIdFormFields = () => {
  return (
    <>
...
export type PatchPersonsIdFormProps = {
  id: number
  defaultValues: PatchPersonsIdFormBody
  onSuccess: () => void
}

export type PatchPersonsIdFormPathParams = { id: number }

export const PatchPersonsIdForm = (props: PatchPersonsIdFormProps) => {
  const form = useForm<PatchPersonsIdFormBody>({
