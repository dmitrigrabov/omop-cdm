...
export type UpdateDeathsIdFormProps = {
  id: string
  defaultValues: Required<UpdateDeathsIdFormBody>
  onSuccess: () => void
}

export type UpdateDeathsIdFormPathParams = { id: string }

export const UpdateDeathsIdForm = (props: UpdateDeathsIdFormProps) => {
  const form = useForm<Required<UpdateDeathsIdFormBody>>({
    resolver: zodResolver(clinicalDeathCreate.required()),
