...
import { useUpdateApiConceptsId } from '@/services/useUpdateApiConceptsId.generated.ts'
...
export type UpdateConceptsIdFormBody = {
  concept_name: string
  domain_id: string
...
export const UpdateConceptsIdForm = (props: UpdateConceptsIdFormProps) => {
  ...
  const mutator = useUpdateApiConceptsId()
