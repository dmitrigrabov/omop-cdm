...
export type UpdateNoteNlpsIdFormProps = {
  id: string
  defaultValues: Required<UpdateNoteNlpsIdFormBody>
  onSuccess: () => void
}

export type UpdateNoteNlpsIdFormPathParams = { id: string }

export const UpdateNoteNlpsIdForm = (props: UpdateNoteNlpsIdFormProps) => {
  const form = useForm<Required<UpdateNoteNlpsIdFormBody>>({
