...
import { useUpdateApiMeasurementsId } from '@/services/useUpdateApiMeasurementsId.generated.ts'
...
export type UpdateMeasurementsIdFormBody = {
  person_id: number
...
export const UpdateMeasurementsIdForm = (
  ...
  const mutator = useUpdateApiMeasurementsId()
