...
import { useUpdateApiDeathsDeathId } from '@/services/useUpdateApiDeathsDeathId.generated.ts'
...
export type UpdateDeathsDeathIdFormBody = {
  person_id: number
  death_date: string
...
export const UpdateDeathsDeathIdFormFields = () => {
  return (
    <>
...
export type UpdateDeathsDeathIdFormProps = {
  death_id: number
  defaultValues: UpdateDeathsDeathIdFormBody
  onSuccess: () => void
}

export type UpdateDeathsDeathIdFormPathParams = { death_id: number }

export const UpdateDeathsDeathIdForm = (
  props: UpdateDeathsDeathIdFormProps,
) => {
  const form = useForm<UpdateDeathsDeathIdFormBody>({
  ...
  const mutator = useUpdateApiDeathsDeathId()
