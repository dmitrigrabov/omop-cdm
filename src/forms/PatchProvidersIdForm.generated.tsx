...
import { usePatchApiProvidersId } from '@/services/usePatchApiProvidersId.generated.ts'
...
export type PatchProvidersIdFormBody = {
...
export const PatchProvidersIdForm = (props: PatchProvidersIdFormProps) => {
  ...
  const mutator = usePatchApiProvidersId()
