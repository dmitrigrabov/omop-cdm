...
import { usePatchApiMetadatasId } from '@/services/usePatchApiMetadatasId.generated.ts'
...
export type PatchMetadatasIdFormBody = {
...
export const PatchMetadatasIdForm = (props: PatchMetadatasIdFormProps) => {
  ...
  const mutator = usePatchApiMetadatasId()
