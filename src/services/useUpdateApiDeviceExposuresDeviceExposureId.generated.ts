...
export type UseUpdateApiDeviceExposuresDeviceExposureIdArgs = {
  device_exposure_id: number
  body: ClinicalDeviceExposureCreate
}

export const useUpdateApiDeviceExposuresDeviceExposureId = (
  args: UseMutationOptions<
    ClinicalDeviceExposure,
    Error,
    UseUpdateApiDeviceExposuresDeviceExposureIdArgs,
    unknown
  > = {},
) => {
