import { useGetApiDomains } from '@/services/useGetApiDomains.generated.ts'
import {
  SelectItem,
  Select,
  SelectContent,
...
export type DomainsSelectFieldProps = {
  lens: Lens<string>
  label?: string
  placeholder?: string
}

export const DomainsSelectField = ({
  label,
  lens,
  placeholder,
}: DomainsSelectFieldProps) => {
  if (!lens) {
    return null
  }
