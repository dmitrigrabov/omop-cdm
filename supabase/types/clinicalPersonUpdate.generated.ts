...
export const clinicalPersonUpdate = z.object({
  ...
  race_concept_id: z.number().int().optional(),
  ethnicity_concept_id: z.number().int().optional(),
...
export type ClinicalPersonUpdate = {
